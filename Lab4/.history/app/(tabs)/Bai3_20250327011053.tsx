...
import TrackPlayer from "react-native-track-player"; { Capability } from 'react-native-track-player'; // Ensure Capability is imported correctly
const playlist = [
    {
        title: "Bài 1",
        ...
        (async () => {
            try {
                ...
                await TrackPlayer.updateOptions({
                    capabilities: [
                        Capability.Play, // Ensure these capabilities are correctly referenced
                        Capability.Pause,
                        Capability.Stop,
                        Capability.SeekTo,
